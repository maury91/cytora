...
export type AugmentedStarship = WithType<WithId<Starship>, "Starship">;

export const transformStarship = (starship: Starship): AugmentedStarship => ({
  ...starship,
  id: extractId(`${SWAPI_ENDPOINT}/starships`, starship.url),
  films: starship.films.map(extractForeignerKey),
  pilots: starship.pilots.map(extractForeignerKey),
  type: "Starship",
});
